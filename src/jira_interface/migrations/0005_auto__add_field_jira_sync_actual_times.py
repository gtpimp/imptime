...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jira.sync_actual_times'
        db.add_column('jira_interface_jira', 'sync_actual_times',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jira.sync_actual_times'
        db.delete_column('jira_interface_jira', 'sync_actual_times')
