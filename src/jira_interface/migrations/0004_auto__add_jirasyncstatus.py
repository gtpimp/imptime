...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JiraSyncStatus'
        db.create_table('jira_interface_jirasyncstatus', (
        ...
        db.send_create_signal('jira_interface', ['JiraSyncStatus'])


    def backwards(self, orm):
        # Deleting model 'JiraSyncStatus'
        db.delete_table('jira_interface_jirasyncstatus')
