...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jira.sync_issue_ordering'
        db.delete_column('jira_interface_jira', 'sync_issue_ordering')

        # Adding field 'Jira.sync_issue_ordering_to_jira'
        db.add_column('jira_interface_jira', 'sync_issue_ordering_to_jira',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Jira.sync_issue_ordering_from_jira'
        db.add_column('jira_interface_jira', 'sync_issue_ordering_from_jira',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Jira.sync_issue_ordering'
        db.add_column('jira_interface_jira', 'sync_issue_ordering',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Jira.sync_issue_ordering_to_jira'
        db.delete_column('jira_interface_jira', 'sync_issue_ordering_to_jira')

        # Deleting field 'Jira.sync_issue_ordering_from_jira'
        db.delete_column('jira_interface_jira', 'sync_issue_ordering_from_jira')
    ...
    models = {
        ...
        'jira_interface.jira': {
            ...
            'primary_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'primary_user'", 'null': 'True', 'to': "orm['auth.User']"}),
