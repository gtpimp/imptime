...
class MultipleIssueSummaryViewSet(BaseViewSet):
    ...
    def list(self, request):
        ...
        try:
            ...
            calculator = MultipleIssueSummaryCalculator(self.request, issue_qs=issue_qs, summary_id=summary_id)
...
class MultipleIssueSummaryCalculator(object):
    ...
    def __init__(self, request, issue_qs, summary_id=None):
    ...
    def _set_permissions(self, issues_qs):
        ...
        for project_id in issues_qs.values('project__business__id')\
            ...
            bp = BusinessPermissions.for_user(self.request.user, project, auto_create=False)  # sic
