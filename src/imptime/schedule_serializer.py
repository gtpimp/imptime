...
class ScheduleSerializer(BaseModelSerializer):
    ...
    viewer_ids = serializers.ListField(child=serializers.CharField())
    editor_ids = serializers.ListField(child=serializers.CharField())
    modified = serializers.DateTimeField()

    class Meta:
        model = Schedule 
        fields = ('id', 'name', 'owner_id', 'viewer_ids',
                  'editor_ids', 'modified')
