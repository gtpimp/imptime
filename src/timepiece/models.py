...
class BusinessPermissions(models.Model):
    ...
    def get_users_who_can_capture_time(self):
        ...
        users = User.objects.filter(is_active=True, business_permissions__can_view_project_card=True, business_permissions__business__new_business_projects__status2='in dev').distinct()
        return users
