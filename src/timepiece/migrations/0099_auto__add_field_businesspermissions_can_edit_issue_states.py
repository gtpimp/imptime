...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_issue_states'
        db.add_column('timepiece_businesspermissions', 'can_edit_issue_states',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_issue_states'
        db.delete_column('timepiece_businesspermissions', 'can_edit_issue_states')
