...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timepiece_calendarevent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='ready', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarEvent.status'
        db.delete_column(u'timepiece_calendarevent', 'status')
