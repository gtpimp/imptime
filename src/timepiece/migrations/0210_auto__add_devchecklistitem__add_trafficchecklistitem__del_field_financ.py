...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DevChecklistItem'
        db.create_table(u'timepiece_devchecklistitem', (
            ...
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Issue'], null=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], null=True, blank=True)),
            ('dev_checklist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', blank=True, to=orm['timepiece.DevChecklist'])),
        ))
        db.send_create_signal(u'timepiece', ['DevChecklistItem'])

        # Adding model 'TrafficChecklistItem'
        db.create_table(u'timepiece_trafficchecklistitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('passed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('msg', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Issue'], null=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], null=True, blank=True)),
            ('traffic_checklist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', blank=True, to=orm['timepiece.TrafficChecklist'])),
        ))
        db.send_create_signal(u'timepiece', ['TrafficChecklistItem'])

        # Deleting field 'FinanceChecklist.modified_by'
        db.delete_column(u'timepiece_financechecklist', 'modified_by_id')

        # Deleting field 'FinanceChecklist.created_by'
        db.delete_column(u'timepiece_financechecklist', 'created_by_id')

        # Deleting field 'FinanceChecklist.created_at'
        db.delete_column(u'timepiece_financechecklist', 'created_at')

        # Deleting field 'FinanceChecklist.modified_at'
        db.delete_column(u'timepiece_financechecklist', 'modified_at')

        # Deleting field 'TrafficChecklist.is_deadline_clear_to_client'
        db.delete_column(u'timepiece_trafficchecklist', 'is_deadline_clear_to_client')

        # Deleting field 'TrafficChecklist.is_requote_required'
        db.delete_column(u'timepiece_trafficchecklist', 'is_requote_required')

        # Deleting field 'TrafficChecklist.has_incoming_issues_created'
        db.delete_column(u'timepiece_trafficchecklist', 'has_incoming_issues_created')

        # Deleting field 'TrafficChecklist.have_made_new_staging_release_today'
        db.delete_column(u'timepiece_trafficchecklist', 'have_made_new_staging_release_today')

        # Deleting field 'TrafficChecklist.all_calendar_entries_assigned_per_developer'
        db.delete_column(u'timepiece_trafficchecklist', 'all_calendar_entries_assigned_per_developer')

        # Deleting field 'TrafficChecklist.has_issues_for_testing'
        db.delete_column(u'timepiece_trafficchecklist', 'has_issues_for_testing')

        # Deleting field 'TrafficChecklist.have_all_new_quotes_been_sent'
        db.delete_column(u'timepiece_trafficchecklist', 'have_all_new_quotes_been_sent')

        # Deleting field 'TrafficChecklist.has_communicated_with_client_this_week'
        db.delete_column(u'timepiece_trafficchecklist', 'has_communicated_with_client_this_week')

        # Deleting field 'TrafficChecklist.has_sprints_to_invoice'
        db.delete_column(u'timepiece_trafficchecklist', 'has_sprints_to_invoice')

        # Deleting field 'TrafficChecklist.have_pending_requotes_been_sent'
        db.delete_column(u'timepiece_trafficchecklist', 'have_pending_requotes_been_sent')

        # Deleting field 'TrafficChecklist.has_deadline_been_set'
        db.delete_column(u'timepiece_trafficchecklist', 'has_deadline_been_set')

        # Deleting field 'TrafficChecklist.has_existing_quoted_accepted'
        db.delete_column(u'timepiece_trafficchecklist', 'has_existing_quoted_accepted')

        # Deleting field 'TrafficChecklist.is_quote_required'
        db.delete_column(u'timepiece_trafficchecklist', 'is_quote_required')

        # Deleting field 'TrafficChecklist.has_existing_quotes_waiting_for_acceptance'
        db.delete_column(u'timepiece_trafficchecklist', 'has_existing_quotes_waiting_for_acceptance')

        # Adding field 'TrafficChecklist.modified_at'
        db.add_column(u'timepiece_trafficchecklist', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 12, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TrafficChecklist.modified_by'
        db.add_column(u'timepiece_trafficchecklist', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='traffic_checklist_modified_by', blank=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'DevChecklist.are_the_estimates_consistently_over'
        db.delete_column(u'timepiece_devchecklist', 'are_the_estimates_consistently_over')

        # Deleting field 'DevChecklist.has_incoming_issues_created'
        db.delete_column(u'timepiece_devchecklist', 'has_incoming_issues_created')

        # Deleting field 'DevChecklist.have_incoming_issues_beenallocated'
        db.delete_column(u'timepiece_devchecklist', 'have_incoming_issues_beenallocated')

        # Deleting field 'DevChecklist.are_all_issues_assigned_to_a_user'
        db.delete_column(u'timepiece_devchecklist', 'are_all_issues_assigned_to_a_user')

        # Deleting field 'DevChecklist.has_sprints_to_invoice'
        db.delete_column(u'timepiece_devchecklist', 'has_sprints_to_invoice')

        # Deleting field 'DevChecklist.description_has_testable'
        db.delete_column(u'timepiece_devchecklist', 'description_has_testable')

        # Deleting field 'DevChecklist.has_reviewed_description_for_todays_issues'
        db.delete_column(u'timepiece_devchecklist', 'has_reviewed_description_for_todays_issues')

        # Deleting field 'DevChecklist.are_all_issues_estimated'
        db.delete_column(u'timepiece_devchecklist', 'are_all_issues_estimated')

        # Deleting field 'DevChecklist.has_reviewed_previous_days_issues'
        db.delete_column(u'timepiece_devchecklist', 'has_reviewed_previous_days_issues')

        # Adding field 'DevChecklist.modified_at'
        db.add_column(u'timepiece_devchecklist', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 12, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DevChecklist.modified_by'
        db.add_column(u'timepiece_devchecklist', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='dev_checklist_modified_by', blank=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DevChecklistItem'
        db.delete_table(u'timepiece_devchecklistitem')

        # Deleting model 'TrafficChecklistItem'
        db.delete_table(u'timepiece_trafficchecklistitem')

        # Adding field 'FinanceChecklist.modified_by'
        db.add_column(u'timepiece_financechecklist', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='finance_checklist_modified_by', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'FinanceChecklist.created_by'
        db.add_column(u'timepiece_financechecklist', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='finance_checklist_created_by', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'FinanceChecklist.created_at'
        db.add_column(u'timepiece_financechecklist', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 12, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'FinanceChecklist.modified_at'
        db.add_column(u'timepiece_financechecklist', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 12, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TrafficChecklist.is_deadline_clear_to_client'
        db.add_column(u'timepiece_trafficchecklist', 'is_deadline_clear_to_client',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.is_requote_required'
        db.add_column(u'timepiece_trafficchecklist', 'is_requote_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_incoming_issues_created'
        db.add_column(u'timepiece_trafficchecklist', 'has_incoming_issues_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.have_made_new_staging_release_today'
        db.add_column(u'timepiece_trafficchecklist', 'have_made_new_staging_release_today',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.all_calendar_entries_assigned_per_developer'
        db.add_column(u'timepiece_trafficchecklist', 'all_calendar_entries_assigned_per_developer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_issues_for_testing'
        db.add_column(u'timepiece_trafficchecklist', 'has_issues_for_testing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.have_all_new_quotes_been_sent'
        db.add_column(u'timepiece_trafficchecklist', 'have_all_new_quotes_been_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_communicated_with_client_this_week'
        db.add_column(u'timepiece_trafficchecklist', 'has_communicated_with_client_this_week',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_sprints_to_invoice'
        db.add_column(u'timepiece_trafficchecklist', 'has_sprints_to_invoice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.have_pending_requotes_been_sent'
        db.add_column(u'timepiece_trafficchecklist', 'have_pending_requotes_been_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_deadline_been_set'
        db.add_column(u'timepiece_trafficchecklist', 'has_deadline_been_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_existing_quoted_accepted'
        db.add_column(u'timepiece_trafficchecklist', 'has_existing_quoted_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.is_quote_required'
        db.add_column(u'timepiece_trafficchecklist', 'is_quote_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.has_existing_quotes_waiting_for_acceptance'
        db.add_column(u'timepiece_trafficchecklist', 'has_existing_quotes_waiting_for_acceptance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TrafficChecklist.modified_at'
        db.delete_column(u'timepiece_trafficchecklist', 'modified_at')

        # Deleting field 'TrafficChecklist.modified_by'
        db.delete_column(u'timepiece_trafficchecklist', 'modified_by_id')

        # Adding field 'DevChecklist.are_the_estimates_consistently_over'
        db.add_column(u'timepiece_devchecklist', 'are_the_estimates_consistently_over',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.has_incoming_issues_created'
        db.add_column(u'timepiece_devchecklist', 'has_incoming_issues_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.have_incoming_issues_beenallocated'
        db.add_column(u'timepiece_devchecklist', 'have_incoming_issues_beenallocated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.are_all_issues_assigned_to_a_user'
        db.add_column(u'timepiece_devchecklist', 'are_all_issues_assigned_to_a_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.has_sprints_to_invoice'
        db.add_column(u'timepiece_devchecklist', 'has_sprints_to_invoice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.description_has_testable'
        db.add_column(u'timepiece_devchecklist', 'description_has_testable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.has_reviewed_description_for_todays_issues'
        db.add_column(u'timepiece_devchecklist', 'has_reviewed_description_for_todays_issues',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.are_all_issues_estimated'
        db.add_column(u'timepiece_devchecklist', 'are_all_issues_estimated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.has_reviewed_previous_days_issues'
        db.add_column(u'timepiece_devchecklist', 'has_reviewed_previous_days_issues',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DevChecklist.modified_at'
        db.delete_column(u'timepiece_devchecklist', 'modified_at')

        # Deleting field 'DevChecklist.modified_by'
        db.delete_column(u'timepiece_devchecklist', 'modified_by_id')
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'calendar_events'", 'null': 'True', 'to': u"orm['timepiece.Project']"}),
        ...
        u'timepiece.entry': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['timepiece.Project']"}),
