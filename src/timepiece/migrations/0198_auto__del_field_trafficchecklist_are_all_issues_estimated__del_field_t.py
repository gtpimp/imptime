...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrafficChecklist.are_all_issues_estimated'
        db.delete_column(u'timepiece_trafficchecklist', 'are_all_issues_estimated')

        # Deleting field 'TrafficChecklist.have_incoming_issues_beenallocated'
        db.delete_column(u'timepiece_trafficchecklist', 'have_incoming_issues_beenallocated')

        # Deleting field 'DevChecklist.are_the_estimates_wildly_out'
        db.delete_column(u'timepiece_devchecklist', 'are_the_estimates_wildly_out')
    ...
    def backwards(self, orm):
        # Adding field 'TrafficChecklist.are_all_issues_estimated'
        db.add_column(u'timepiece_trafficchecklist', 'are_all_issues_estimated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TrafficChecklist.have_incoming_issues_beenallocated'
        db.add_column(u'timepiece_trafficchecklist', 'have_incoming_issues_beenallocated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DevChecklist.are_the_estimates_wildly_out'
        db.add_column(u'timepiece_devchecklist', 'are_the_estimates_wildly_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'timepiece.devchecklist': {
            ...
            'are_all_issues_estimated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'are_the_estimates_consistently_over': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'description_has_testable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_incoming_issues_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_reviewed_description_for_todays_issues': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_reviewed_previous_days_issues': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_sprints_to_invoice': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'have_incoming_issues_beenallocated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'timepiece.financechecklist': {
            ...
            'are_rates_correct': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Business']", 'blank': 'True'}),
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'finance_checklist_created_by'", 'to': u"orm['auth.User']"}),
            'has_valid_budget': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_currently_under_budget': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_projected_cost_in_budget': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'passed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'timepiece.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interface_plugin_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'invoice_at': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            ...
            'start_client_qa_at': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'start_dev_at': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'start_internal_qa_at': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        u'timepiece.trafficchecklist': {
            ...
            'all_calendar_entries_assigned_per_developer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Business']", 'blank': 'True'}),
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'traffic_checklist_created_by'", 'to': u"orm['auth.User']"}),
            'has_communicated_with_client_this_week': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_deadline_been_set': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_existing_quoted_accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_existing_quotes_waiting_for_acceptance': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_incoming_issues_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_issues_for_testing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'has_sprints_to_invoice': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'have_all_new_quotes_been_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'have_made_new_staging_release_today': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'have_pending_requotes_been_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deadline_clear_to_client': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_quote_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_requote_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'passed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
