...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarEvent.description'
        db.add_column(u'timepiece_calendarevent', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CalendarEvent.project'
        db.alter_column(u'timepiece_calendarevent', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timepiece.Project']))

    def backwards(self, orm):
        # Deleting field 'CalendarEvent.description'
        db.delete_column(u'timepiece_calendarevent', 'description')


        # Changing field 'CalendarEvent.project'
        db.alter_column(u'timepiece_calendarevent', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Project']))
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '2.0', 'max_digits': '4', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
