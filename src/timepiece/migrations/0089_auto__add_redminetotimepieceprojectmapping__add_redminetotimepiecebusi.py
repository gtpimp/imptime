...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RedmineToTimepieceProjectMapping'
        db.create_table('timepiece_redminetotimepieceprojectmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('redmine_project_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('timepiece_project_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('timepiece', ['RedmineToTimepieceProjectMapping'])

        # Adding model 'RedmineToTimepieceBusinessMapping'
        db.create_table('timepiece_redminetotimepiecebusinessmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('redmine_business_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('timepiece_business_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('timepiece', ['RedmineToTimepieceBusinessMapping'])


    def backwards(self, orm):
        # Deleting model 'RedmineToTimepieceProjectMapping'
        db.delete_table('timepiece_redminetotimepieceprojectmapping')

        # Deleting model 'RedmineToTimepieceBusinessMapping'
        db.delete_table('timepiece_redminetotimepiecebusinessmapping')
    ...
    models = {
        ...
        'timepiece.redminetotimepieceprojectmapping': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redmine_project_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'timepiece_project_name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
