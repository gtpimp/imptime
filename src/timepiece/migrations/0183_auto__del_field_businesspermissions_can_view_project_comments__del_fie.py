...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPermissions.can_view_project_comments'
        db.delete_column(u'timepiece_businesspermissions', 'can_view_project_comments')

        # Deleting field 'BusinessPermissions.can_edit_project_comments'
        db.delete_column(u'timepiece_businesspermissions', 'can_edit_project_comments')

        # Adding field 'BusinessPermissions.can_view_business_comments'
        db.add_column(u'timepiece_businesspermissions', 'can_view_business_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_business_comments'
        db.add_column(u'timepiece_businesspermissions', 'can_edit_business_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BusinessPermissions.can_view_project_comments'
        db.add_column(u'timepiece_businesspermissions', 'can_view_project_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_project_comments'
        db.add_column(u'timepiece_businesspermissions', 'can_edit_project_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'BusinessPermissions.can_view_business_comments'
        db.delete_column(u'timepiece_businesspermissions', 'can_view_business_comments')

        # Deleting field 'BusinessPermissions.can_edit_business_comments'
        db.delete_column(u'timepiece_businesspermissions', 'can_edit_business_comments')
