...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Salary.paye'
        db.add_column('timepiece_salary', 'paye',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0),
                      keep_default=False)

        # Adding field 'Salary.uif'
        db.add_column('timepiece_salary', 'uif',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Salary.paye'
        db.delete_column('timepiece_salary', 'paye')

        # Deleting field 'Salary.uif'
        db.delete_column('timepiece_salary', 'uif')
    ...
    models = {
        ...
        'timepiece.salary': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paye': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '0'}),
            'uif': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
