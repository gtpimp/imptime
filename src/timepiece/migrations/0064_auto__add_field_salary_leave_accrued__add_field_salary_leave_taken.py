...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Salary.leave_accrued'
        db.add_column('timepiece_salary', 'leave_accrued',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Salary.leave_taken'
        db.add_column('timepiece_salary', 'leave_taken',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Salary.leave_accrued'
        db.delete_column('timepiece_salary', 'leave_accrued')

        # Deleting field 'Salary.leave_taken'
        db.delete_column('timepiece_salary', 'leave_taken')
