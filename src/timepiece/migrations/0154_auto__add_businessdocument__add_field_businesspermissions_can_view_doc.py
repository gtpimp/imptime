...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessDocument'
        db.create_table('timepiece_businessdocument', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', to=orm['timepiece.Business'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('doc', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('doc_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('timepiece', ['BusinessDocument'])

        # Adding field 'BusinessPermissions.can_view_documents'
        db.add_column('timepiece_businesspermissions', 'can_view_documents',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BusinessDocument'
        db.delete_table('timepiece_businessdocument')

        # Deleting field 'BusinessPermissions.can_view_documents'
        db.delete_column('timepiece_businesspermissions', 'can_view_documents')
