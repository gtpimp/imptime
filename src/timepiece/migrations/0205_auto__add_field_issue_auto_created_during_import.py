...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.auto_created_during_import'
        db.add_column(u'timepiece_issue', 'auto_created_during_import',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.auto_created_during_import'
        db.delete_column(u'timepiece_issue', 'auto_created_during_import')
