...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.quote_uncertainty'
        db.add_column('timepiece_project', 'quote_uncertainty',
                      self.gf('django.db.models.fields.FloatField')(default=0.25, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Project.colour'
        db.alter_column('timepiece_project', 'colour', self.gf('colorful.fields.RGBColorField')(max_length=7, null=True))

    def backwards(self, orm):
        # Deleting field 'Project.quote_uncertainty'
        db.delete_column('timepiece_project', 'quote_uncertainty')


        # Changing field 'Project.colour'
        db.alter_column('timepiece_project', 'colour', self.gf('colorful.fields.RGBColorField')(default=None, max_length=7))
