...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        content_type = ContentType.objects.get_or_create(app_label="timepiece", model="Business")[0]

        Permission.objects.create(codename='belongs_to_all_projects', name='Belongs to all projects', content_type=content_type)
