...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPermissions.users'
        db.delete_column('timepiece_businesspermissions', 'users_id')

        # Adding field 'BusinessPermissions.user'
        db.add_column('timepiece_businesspermissions', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='business_permissions', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BusinessPermissions.users'
        raise RuntimeError("Cannot reverse this migration. 'BusinessPermissions.users' and its values cannot be restored.")
        # Deleting field 'BusinessPermissions.user'
        db.delete_column('timepiece_businesspermissions', 'user_id')
