...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RedmineToTimepieceProjectMapping.redmine_project_name'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'redmine_project_name')

        # Deleting field 'RedmineToTimepieceProjectMapping.timepiece_project_name'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_project_name')

        # Adding field 'RedmineToTimepieceProjectMapping.redmine_project_code'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'redmine_project_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RedmineToTimepieceProjectMapping.timepiece_project_code'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_project_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RedmineToTimepieceProjectMapping.redmine_project_name'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'redmine_project_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RedmineToTimepieceProjectMapping.timepiece_project_name'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_project_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'RedmineToTimepieceProjectMapping.redmine_project_code'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'redmine_project_code')

        # Deleting field 'RedmineToTimepieceProjectMapping.timepiece_project_code'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_project_code')
