...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrafficChecklist'
        db.create_table(u'timepiece_trafficchecklist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], blank=True)),
            ('have_made_new_staging_release_today', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_incoming_issues_created', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('are_all_issues_estimated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('have_incoming_issues_beenallocated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_requote_required', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('have_pending_requotes_been_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_quote_required', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('have_all_new_quotes_been_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_existing_quotes_waiting_for_acceptance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_existing_quoted_accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_sprints_to_invoice', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_issues_for_testing', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_deadline_been_set', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_deadline_clear_to_client', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_communicated_with_client_this_week', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('all_calendar_entries_assigned_per_developer', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='traffic_checklist_created_by', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'timepiece', ['TrafficChecklist'])


    def backwards(self, orm):
        # Deleting model 'TrafficChecklist'
        db.delete_table(u'timepiece_trafficchecklist')
    ...
    models = {
        ...
        u'timepiece.trafficchecklist': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Project']", 'blank': 'True'})
        },
