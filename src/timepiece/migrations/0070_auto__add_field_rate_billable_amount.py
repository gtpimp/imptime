...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rate.billable_amount'
        db.add_column('timepiece_rate', 'billable_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rate.billable_amount'
        db.delete_column('timepiece_rate', 'billable_amount')
