...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_invoice', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('timepiece', ['Invoice'])


        # Changing field 'Expense.project'
        db.alter_column('timepiece_expense', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['timepiece.Project']))

    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table('timepiece_invoice')


        # Changing field 'Expense.project'
        db.alter_column('timepiece_expense', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['timepiece.Project']))
