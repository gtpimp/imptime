...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timepiece_entry', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.created'
        db.delete_column(u'timepiece_entry', 'created')
    ...
    models = {
        ...
        u'timepiece.businesspermissions': {
            ...
            'can_edit_quotes': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'can_view_quotes': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'timepiece.calendarevent': {
            ...
            'caldav_uid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_invites_to': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'timepiece.entry': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries_created_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'timepiece.feature': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name', 'business'),)", 'object_name': 'Feature'},
        ...
        u'timepiece.rate': {
            ...
            'time_tracking_mode': ('django.db.models.fields.CharField', [], {'default': "'developer'", 'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'timepiece.schedule': {
            'Meta': {'object_name': 'Schedule'},
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Business']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_hours': ('django.db.models.fields.IntegerField', [], {}),
            'scheduled_date': ('django.db.models.fields.DateField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schedules'", 'to': u"orm['auth.User']"})
        },
