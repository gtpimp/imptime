...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessDocument.modified_at'
        db.add_column('timepiece_businessdocument', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BusinessDocument.modified_by'
        db.add_column('timepiece_businessdocument', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='business_document_modified_by', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessDocument.modified_at'
        db.delete_column('timepiece_businessdocument', 'modified_at')

        # Deleting field 'BusinessDocument.modified_by'
        db.delete_column('timepiece_businessdocument', 'modified_by_id')
    ...
    models = {
        ...
        'timepiece.businessdocument': {
            'Meta': {'object_name': 'BusinessDocument'},
            'business': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'documents'", 'to': "orm['timepiece.Business']"}),
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'business_document_created_by'", 'to': "orm['auth.User']"}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'business_document_modified_by'", 'to': "orm['auth.User']"}),
        ...
        'timepiece.businesspermissions': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'business_permissions'", 'to': "orm['auth.User']"})
        },
        ...
        'timepiece.entry': {
            ...
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'to': "orm['timepiece.Issue']"}),
        ...
        'timepiece.feature': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'features'", 'to': "orm['timepiece.Business']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'timepiece.issue': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'issues'", 'null': 'True', 'to': "orm['timepiece.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'timepiece.issueattachment': {
            'Meta': {'object_name': 'IssueAttachment'},
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachments'", 'to': "orm['timepiece.Issue']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'timepiece.issuecomment': {
            'Meta': {'object_name': 'IssueComment'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issue_comments'", 'to': "orm['auth.User']"}),
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['timepiece.Issue']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'timepiece.issuehistory': {
        ...
        'timepiece.issuepoints': {
            'Meta': {'unique_together': "(('user', 'issue'),)", 'object_name': 'IssuePoints'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issue_points'", 'to': "orm['timepiece.Issue']"}),
            'points': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_points'", 'to': "orm['auth.User']"})
        },
        'timepiece.issuestatus': {
            'Meta': {'unique_together': "(('name', 'business'),)", 'object_name': 'IssueStatus'},
            'business': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stati'", 'to': "orm['timepiece.Business']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'timepiece.location': {
        ...
        'timepiece.userprofile': {
            ...
            'billable_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jira_user_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
