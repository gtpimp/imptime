...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_description'
        db.add_column('timepiece_businesspermissions', 'can_edit_description',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_subject'
        db.add_column('timepiece_businesspermissions', 'can_edit_subject',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_description'
        db.delete_column('timepiece_businesspermissions', 'can_edit_description')

        # Deleting field 'BusinessPermissions.can_edit_subject'
        db.delete_column('timepiece_businesspermissions', 'can_edit_subject')
