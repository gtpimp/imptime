...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timepiece_financechecklist', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 12, 13, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'timepiece.financechecklist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'finance_checklist_modified_by'", 'to': u"orm['auth.User']"}),
            'passed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'})
        },
