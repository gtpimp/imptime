...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_import_actual_hours'
        db.add_column(u'timepiece_businesspermissions', 'can_import_actual_hours',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_import_actual_hours'
        db.delete_column(u'timepiece_businesspermissions', 'can_import_actual_hours')
    ...
    models = {
        ...
        u'timepiece.project': {
            ...
            'status2': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '100'}),
