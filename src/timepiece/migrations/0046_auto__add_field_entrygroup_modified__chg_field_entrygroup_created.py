...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryGroup.created'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EntryGroup.modified'
        db.delete_column('timepiece_entrygroup', 'modified')

        # Changing field 'EntryGroup.created'
        db.alter_column('timepiece_entrygroup', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
