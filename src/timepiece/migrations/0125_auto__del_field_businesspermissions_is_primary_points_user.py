...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPermissions.is_primary_points_user'
        db.delete_column('timepiece_businesspermissions', 'is_primary_points_user')


    def backwards(self, orm):
        # Adding field 'BusinessPermissions.is_primary_points_user'
        db.add_column('timepiece_businesspermissions', 'is_primary_points_user',
