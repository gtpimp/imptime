...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssuePoints.issue'
        db.add_column('timepiece_issuepoints', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='user_points', to=orm['timepiece.Issue']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssuePoints.issue'
        db.delete_column('timepiece_issuepoints', 'issue_id')
