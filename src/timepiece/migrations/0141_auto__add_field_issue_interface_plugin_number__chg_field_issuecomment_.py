...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.interface_plugin_number'
        db.add_column('timepiece_issue', 'interface_plugin_number',
    ...
    def backwards(self, orm):
        # Deleting field 'Issue.interface_plugin_number'
        db.delete_column('timepiece_issue', 'interface_plugin_number')
