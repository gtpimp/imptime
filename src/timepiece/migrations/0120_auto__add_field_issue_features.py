...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.features'
        db.add_column('timepiece_issue', 'features',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='issues', null=True, to=orm['timepiece.Feature']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Issue.features'
        db.delete_column('timepiece_issue', 'features_id')
    ...
    models = {
        ...
        'timepiece.issue': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'features': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'issues'", 'null': 'True', 'to': "orm['timepiece.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
