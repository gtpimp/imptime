...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'timepiece_schedule', 'date')

        # Adding field 'Schedule.scheduled_date'
        db.add_column(u'timepiece_schedule', 'scheduled_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 3, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Schedule.date'
        db.add_column(u'timepiece_schedule', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 3, 16, 0, 0)),
                      keep_default=False)

        # Deleting field 'Schedule.scheduled_date'
        db.delete_column(u'timepiece_schedule', 'scheduled_date')
