...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.extended_comments'
        db.add_column('timepiece_entry', 'extended_comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.extended_comments'
        db.delete_column('timepiece_entry', 'extended_comments')
