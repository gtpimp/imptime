...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timepiece_entry', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entries_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.created_by'
        db.delete_column(u'timepiece_entry', 'created_by_id')
