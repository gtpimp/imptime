...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.project'
        db.add_column('timepiece_expense', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True,default=None, related_name='expense', to=orm['timepiece.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.project'
        db.delete_column('timepiece_expense', 'project_id')
    ...
    models = {
        ...
        'timepiece.expense': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expense'", 'to': "orm['timepiece.Project']"})
        },
        'timepiece.hourgroup': {
