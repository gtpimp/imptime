...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.colour'
        db.add_column('timepiece_project', 'colour',
                      self.gf('colorful.fields.RGBColorField')(default='4c4c4c', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.colour'
        db.delete_column('timepiece_project', 'colour')
