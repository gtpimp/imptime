...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.project_names_to_ignore'
        db.add_column('timepiece_userprofile', 'project_names_to_ignore',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.project_names_to_ignore'
        db.delete_column('timepiece_userprofile', 'project_names_to_ignore')
