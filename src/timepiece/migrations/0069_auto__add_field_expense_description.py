...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.description'
        db.add_column('timepiece_expense', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.description'
        db.delete_column('timepiece_expense', 'description')
