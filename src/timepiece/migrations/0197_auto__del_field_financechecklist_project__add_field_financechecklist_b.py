...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FinanceChecklist.project'
        db.delete_column(u'timepiece_financechecklist', 'project_id')

        # Adding field 'FinanceChecklist.business'
        db.add_column(u'timepiece_financechecklist', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Business'], blank=True),
                      keep_default=False)

        # Deleting field 'TrafficChecklist.project'
        db.delete_column(u'timepiece_trafficchecklist', 'project_id')

        # Adding field 'TrafficChecklist.business'
        db.add_column(u'timepiece_trafficchecklist', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Business'], blank=True),
                      keep_default=False)

        # Deleting field 'DevChecklist.project'
        db.delete_column(u'timepiece_devchecklist', 'project_id')

        # Adding field 'DevChecklist.business'
        db.add_column(u'timepiece_devchecklist', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Business'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FinanceChecklist.project'
        db.add_column(u'timepiece_financechecklist', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Project'], blank=True),
                      keep_default=False)

        # Deleting field 'FinanceChecklist.business'
        db.delete_column(u'timepiece_financechecklist', 'business_id')

        # Adding field 'TrafficChecklist.project'
        db.add_column(u'timepiece_trafficchecklist', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Project'], blank=True),
                      keep_default=False)

        # Deleting field 'TrafficChecklist.business'
        db.delete_column(u'timepiece_trafficchecklist', 'business_id')

        # Adding field 'DevChecklist.project'
        db.add_column(u'timepiece_devchecklist', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Project'], blank=True),
                      keep_default=False)

        # Deleting field 'DevChecklist.business'
        db.delete_column(u'timepiece_devchecklist', 'business_id')
    ...
    models = {
        ...
        u'timepiece.devchecklist': {
            ...
            'are_the_estimates_wildly_out': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
