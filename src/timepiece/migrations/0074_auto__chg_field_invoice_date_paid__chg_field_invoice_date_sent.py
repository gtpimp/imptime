...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.date_paid'
        db.alter_column('timepiece_invoice', 'date_paid', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Invoice.date_sent'
        db.alter_column('timepiece_invoice', 'date_sent', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.date_paid'
        db.alter_column('timepiece_invoice', 'date_paid', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Invoice.date_sent'
        db.alter_column('timepiece_invoice', 'date_sent', self.gf('django.db.models.fields.DateField')(default=None))
