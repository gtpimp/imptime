...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.amount'
        db.add_column('timepiece_userprofile', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'UserProfile.billable_amount'
        db.add_column('timepiece_userprofile', 'billable_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.amount'
        db.delete_column('timepiece_userprofile', 'amount')

        # Deleting field 'UserProfile.billable_amount'
        db.delete_column('timepiece_userprofile', 'billable_amount')
    ...
    models = {
        ...
        'timepiece.userprofile': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'billable_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'default_rate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Rate']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
