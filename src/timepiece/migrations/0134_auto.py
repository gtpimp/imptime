...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Issue', fields ['subject']
        db.create_index('timepiece_issue', ['subject'])


    def backwards(self, orm):
        # Removing index on 'Issue', fields ['subject']
        db.delete_index('timepiece_issue', ['subject'])
