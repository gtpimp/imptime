...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Project.status2'
        db.delete_column(u'timepiece_project', 'status2')
    ...
    models = {
        ...
        u'timepiece.project': {
            ...
            'status2': ('django.db.models.fields.CharField', [], {'default': "'in planning'", 'max_length': '100'}),
