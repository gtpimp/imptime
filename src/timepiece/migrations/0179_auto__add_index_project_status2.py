...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Project', fields ['status2']
        db.create_index(u'timepiece_project', ['status2'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['status2']
        db.delete_index(u'timepiece_project', ['status2'])
