...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_project_detail'
        db.add_column('timepiece_businesspermissions', 'can_edit_project_detail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_issues'
        db.add_column('timepiece_businesspermissions', 'can_edit_issues',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_budget'
        db.add_column('timepiece_businesspermissions', 'can_edit_budget',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_view_budget'
        db.add_column('timepiece_businesspermissions', 'can_view_budget',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_invoices'
        db.add_column('timepiece_businesspermissions', 'can_edit_invoices',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_view_invoices'
        db.add_column('timepiece_businesspermissions', 'can_view_invoices',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_edit_ctc_billable_rates'
        db.add_column('timepiece_businesspermissions', 'can_edit_ctc_billable_rates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_view_ctc_billable_rates'
        db.add_column('timepiece_businesspermissions', 'can_view_ctc_billable_rates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_toggle_graphs'
        db.add_column('timepiece_businesspermissions', 'can_toggle_graphs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_project_detail'
        db.delete_column('timepiece_businesspermissions', 'can_edit_project_detail')

        # Deleting field 'BusinessPermissions.can_edit_issues'
        db.delete_column('timepiece_businesspermissions', 'can_edit_issues')

        # Deleting field 'BusinessPermissions.can_edit_budget'
        db.delete_column('timepiece_businesspermissions', 'can_edit_budget')

        # Deleting field 'BusinessPermissions.can_view_budget'
        db.delete_column('timepiece_businesspermissions', 'can_view_budget')

        # Deleting field 'BusinessPermissions.can_edit_invoices'
        db.delete_column('timepiece_businesspermissions', 'can_edit_invoices')

        # Deleting field 'BusinessPermissions.can_view_invoices'
        db.delete_column('timepiece_businesspermissions', 'can_view_invoices')

        # Deleting field 'BusinessPermissions.can_edit_ctc_billable_rates'
        db.delete_column('timepiece_businesspermissions', 'can_edit_ctc_billable_rates')

        # Deleting field 'BusinessPermissions.can_view_ctc_billable_rates'
        db.delete_column('timepiece_businesspermissions', 'can_view_ctc_billable_rates')

        # Deleting field 'BusinessPermissions.can_toggle_graphs'
        db.delete_column('timepiece_businesspermissions', 'can_toggle_graphs')
    ...
    models = {
        ...
        'timepiece.businesspermissions': {
            'Meta': {'object_name': 'BusinessPermissions'},
        ...
        'timepiece.entry': {
            ...
            'entry_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['timepiece.EntryGroup']"}),
            'extended_comments': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Issue']", 'null': 'True', 'blank': 'True'}),
        ...
        'timepiece.expense': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'expense'", 'null': 'True', 'to': "orm['timepiece.Project']"})
        },
        'timepiece.hourgroup': {
        ...
        'timepiece.invoice': {
            ...
            'paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'invoices'", 'null': 'True', 'to': "orm['timepiece.Project']"})
        },
        'timepiece.issue': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issues'", 'to': "orm['timepiece.Project']"}),
        ...
        'timepiece.projecthours': {
            'Meta': {'unique_together': "(('week_start', 'project', 'user'),)", 'object_name': 'ProjectHours'},
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Project']"}),
        ...
        'timepiece.rate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rate'", 'to': "orm['timepiece.Project']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'timepiece.redminetotimepiecebusinessmapping': {
        ...
        'timepiece.redminetotimepieceprojectmapping': {
