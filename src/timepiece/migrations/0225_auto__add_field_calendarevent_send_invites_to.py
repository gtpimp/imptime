...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarEvent.send_invites_to'
        db.add_column(u'timepiece_calendarevent', 'send_invites_to',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarEvent.send_invites_to'
        db.delete_column(u'timepiece_calendarevent', 'send_invites_to')
