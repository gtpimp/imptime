...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'timepiece_calendarevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'])),
            ('hours_planned', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('hours_worked', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'timepiece', ['CalendarEvent'])

        # Adding field 'BusinessDocument.project'
        db.add_column(u'timepiece_businessdocument', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='documents', null=True, to=orm['timepiece.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CalendarEvent'
        db.delete_table(u'timepiece_calendarevent')

        # Deleting field 'BusinessDocument.project'
        db.delete_column(u'timepiece_businessdocument', 'project_id')
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'hours_planned': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'hours_worked': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
