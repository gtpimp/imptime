...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.feature'
        db.alter_column('timepiece_issue', 'feature_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['timepiece.Feature']))

    def backwards(self, orm):

        # Changing field 'Issue.feature'
        db.alter_column('timepiece_issue', 'feature_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['timepiece.Issue']))
    ...
    models = {
        ...
        'timepiece.issue': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'feature': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'issue'", 'unique': 'True', 'null': 'True', 'to': "orm['timepiece.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
