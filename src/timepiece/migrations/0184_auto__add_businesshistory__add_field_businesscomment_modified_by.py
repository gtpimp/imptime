...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessHistory'
        db.create_table(u'timepiece_businesshistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ...
        db.send_create_signal(u'timepiece', ['BusinessHistory'])

        # Adding field 'BusinessComment.modified_by'
        db.add_column(u'timepiece_businesscomment', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='business_comments_modified_by', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BusinessHistory'
        db.delete_table(u'timepiece_businesshistory')

        # Deleting field 'BusinessComment.modified_by'
        db.delete_column(u'timepiece_businesscomment', 'modified_by_id')
