...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.authenticate_token'
        db.add_column('timepiece_userprofile', 'authenticate_token',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.authenticate_token'
        db.delete_column('timepiece_userprofile', 'authenticate_token')
