...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.feature'
        db.delete_column('timepiece_issue', 'feature_id')

        # Adding M2M table for field features on 'Issue'
        db.create_table('timepiece_issue_features', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['timepiece.issue'], null=False)),
            ('feature', models.ForeignKey(orm['timepiece.feature'], null=False))
        ))
        db.create_unique('timepiece_issue_features', ['issue_id', 'feature_id'])


    def backwards(self, orm):
        # Adding field 'Issue.feature'
        db.add_column('timepiece_issue', 'feature',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='issue', unique=True, null=True, to=orm['timepiece.Feature'], blank=True),
                      keep_default=False)

        # Removing M2M table for field features on 'Issue'
        db.delete_table('timepiece_issue_features')
    ...
    models = {
        ...
        'timepiece.businesspermissions': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_primary_points_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'timepiece.issue': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'features': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'issues'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['timepiece.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
