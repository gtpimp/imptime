...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_see_other_user_points'
        db.add_column('timepiece_businesspermissions', 'can_see_other_user_points',
    ...
    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_see_other_user_points'
        db.delete_column('timepiece_businesspermissions', 'can_see_other_user_points')
