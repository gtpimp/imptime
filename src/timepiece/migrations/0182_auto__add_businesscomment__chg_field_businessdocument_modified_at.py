...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'timepiece_businesscomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='business_comments', to=orm['timepiece.Business'])),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'timepiece', ['BusinessComment'])


        # Changing field 'BusinessDocument.modified_at'
        db.alter_column(u'timepiece_businessdocument', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'BusinessComment'
        db.delete_table(u'timepiece_businesscomment')


        # Changing field 'BusinessDocument.modified_at'
        db.alter_column(u'timepiece_businessdocument', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'timepiece.businesspermissions': {
            ...
            'can_edit_project_comments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'can_view_project_comments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
