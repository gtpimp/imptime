...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'timepiece_calendarevent', 'event_type',
                      self.gf('django.db.models.fields.CharField')(default='work', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarEvent.event_type'
        db.delete_column(u'timepiece_calendarevent', 'event_type')
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'work'", 'max_length': '50'}),
