...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinanceChecklistItem'
        db.create_table(u'timepiece_financechecklistitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('finance_checklist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', blank=True, to=orm['timepiece.FinanceChecklist'])),
        ...
        db.send_create_signal(u'timepiece', ['FinanceChecklistItem'])

        # Deleting field 'FinanceChecklist.all_sprints_closed'
        db.delete_column(u'timepiece_financechecklist', 'all_sprints_closed')

        # Deleting field 'FinanceChecklist.is_projected_cost_in_budget'
        db.delete_column(u'timepiece_financechecklist', 'is_projected_cost_in_budget')

        # Deleting field 'FinanceChecklist.are_rates_correct'
        db.delete_column(u'timepiece_financechecklist', 'are_rates_correct')

        # Deleting field 'FinanceChecklist.all_invoices_sent'
        db.delete_column(u'timepiece_financechecklist', 'all_invoices_sent')

        # Deleting field 'FinanceChecklist.is_currently_under_budget'
        db.delete_column(u'timepiece_financechecklist', 'is_currently_under_budget')

        # Deleting field 'FinanceChecklist.has_valid_budget'
        db.delete_column(u'timepiece_financechecklist', 'has_valid_budget')


    def backwards(self, orm):
        # Deleting model 'FinanceChecklistItem'
        db.delete_table(u'timepiece_financechecklistitem')

        # Adding field 'FinanceChecklist.all_sprints_closed'
        db.add_column(u'timepiece_financechecklist', 'all_sprints_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FinanceChecklist.is_projected_cost_in_budget'
        db.add_column(u'timepiece_financechecklist', 'is_projected_cost_in_budget',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FinanceChecklist.are_rates_correct'
        db.add_column(u'timepiece_financechecklist', 'are_rates_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FinanceChecklist.all_invoices_sent'
        db.add_column(u'timepiece_financechecklist', 'all_invoices_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FinanceChecklist.is_currently_under_budget'
        db.add_column(u'timepiece_financechecklist', 'is_currently_under_budget',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FinanceChecklist.has_valid_budget'
        db.add_column(u'timepiece_financechecklist', 'has_valid_budget',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'timepiece.devchecklist': {
            ...
            'are_all_issues_assigned_to_a_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
