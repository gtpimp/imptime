...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.created'
        db.add_column('timepiece_issue', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Issue.modified'
        db.add_column('timepiece_issue', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.created'
        db.delete_column('timepiece_issue', 'created')

        # Deleting field 'Issue.modified'
        db.delete_column('timepiece_issue', 'modified')
