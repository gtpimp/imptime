...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Salary.uif'
        db.alter_column('timepiece_salary', 'uif', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Salary.paye'
        db.alter_column('timepiece_salary', 'paye', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Salary.uif'
        db.alter_column('timepiece_salary', 'uif', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=0))

        # Changing field 'Salary.paye'
        db.alter_column('timepiece_salary', 'paye', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=0))
