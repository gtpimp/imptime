...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_view_project_card'
        db.add_column('timepiece_businesspermissions', 'can_view_project_card',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_view_project_card'
        db.delete_column('timepiece_businesspermissions', 'can_view_project_card')
