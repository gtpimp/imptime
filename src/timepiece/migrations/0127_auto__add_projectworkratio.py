...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectWorkRatio'
        db.create_table('timepiece_projectworkratio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('development', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('testing', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('management', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'])),
        ))
        db.send_create_signal('timepiece', ['ProjectWorkRatio'])


    def backwards(self, orm):
        # Deleting model 'ProjectWorkRatio'
        db.delete_table('timepiece_projectworkratio')
