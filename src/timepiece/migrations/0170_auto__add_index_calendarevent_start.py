...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CalendarEvent', fields ['start']
        db.create_index(u'timepiece_calendarevent', ['start'])


    def backwards(self, orm):
        # Removing index on 'CalendarEvent', fields ['start']
        db.delete_index(u'timepiece_calendarevent', ['start'])
