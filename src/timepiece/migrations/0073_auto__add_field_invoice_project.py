...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.project'
        db.add_column('timepiece_invoice', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invoices', null=True, to=orm['timepiece.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.project'
        db.delete_column('timepiece_invoice', 'project_id')
