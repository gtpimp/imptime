...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'timepiece.project': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'business_projects'", 'null': 'True', 'to': "orm['crm.Contact']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'new_business': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_business_projects'", 'null': 'True', 'to': "orm['timepiece.Business']"}),
