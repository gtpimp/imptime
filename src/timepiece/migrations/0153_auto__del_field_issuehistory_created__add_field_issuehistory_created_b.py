...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IssueHistory.created'
        db.delete_column('timepiece_issuehistory', 'created')

        # Adding field 'IssueHistory.created_by'
        db.add_column('timepiece_issuehistory', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'IssueHistory.created_at'
        db.add_column('timepiece_issuehistory', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'IssueHistory.created'
        db.add_column('timepiece_issuehistory', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 10, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'IssueHistory.created_by'
        db.delete_column('timepiece_issuehistory', 'created_by_id')

        # Deleting field 'IssueHistory.created_at'
        db.delete_column('timepiece_issuehistory', 'created_at')
