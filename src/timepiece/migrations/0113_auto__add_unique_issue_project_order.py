...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Issue', fields ['project', 'order']
        db.create_unique('timepiece_issue', ['project_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'Issue', fields ['project', 'order']
        db.delete_unique('timepiece_issue', ['project_id', 'order'])
    ...
    models = {
        ...
        'timepiece.issue': {
            'Meta': {'unique_together': "(('project', 'order'),)", 'object_name': 'Issue'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
