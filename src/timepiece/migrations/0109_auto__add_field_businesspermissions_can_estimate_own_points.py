...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_estimate_own_points'
        db.add_column('timepiece_businesspermissions', 'can_estimate_own_points',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_estimate_own_points'
        db.delete_column('timepiece_businesspermissions', 'can_estimate_own_points')
