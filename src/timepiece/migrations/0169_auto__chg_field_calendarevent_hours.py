...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalendarEvent.hours'
        db.alter_column(u'timepiece_calendarevent', 'hours', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'CalendarEvent.hours'
        db.alter_column(u'timepiece_calendarevent', 'hours', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1))
