...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.default_rate'
        db.add_column('timepiece_userprofile', 'default_rate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Rate'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.default_rate'
        db.delete_column('timepiece_userprofile', 'default_rate_id')
