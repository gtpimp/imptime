...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Issue'
        db.create_table('timepiece_issue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='issues', to=orm['timepiece.Project'])),
            ('subject', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('story_points', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('timepiece', ['Issue'])

        # Adding field 'Entry.issue'
        db.add_column('timepiece_entry', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Issue'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Issue'
        db.delete_table('timepiece_issue')

        # Deleting field 'Entry.issue'
        db.delete_column('timepiece_entry', 'issue_id')
