...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_do_finance_checklist'
        db.add_column(u'timepiece_businesspermissions', 'can_do_finance_checklist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_do_finance_checklist'
        db.delete_column(u'timepiece_businesspermissions', 'can_do_finance_checklist')
