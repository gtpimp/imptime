...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        staff_usernames = [ 'gtp', 'alec', 'keith', 'david', 'gassan', 'eustace', 'jarryd', 'george' ]
        orm['auth.user'].objects.update(is_staff=False)
        orm['auth.user'].objects.filter(username__in=staff_usernames).update(is_staff=True)
