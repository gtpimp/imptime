...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_be_scheduled'
        db.add_column(u'timepiece_businesspermissions', 'can_be_scheduled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_be_scheduled'
        db.delete_column(u'timepiece_businesspermissions', 'can_be_scheduled')
