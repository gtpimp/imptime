...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrafficChecklist.passed'
        db.add_column(u'timepiece_trafficchecklist', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrafficChecklist.passed'
        db.delete_column(u'timepiece_trafficchecklist', 'passed')
