...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssuePoints'
        db.create_table('timepiece_issuepoints', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('points', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('timepiece', ['IssuePoints'])


    def backwards(self, orm):
        # Deleting model 'IssuePoints'
        db.delete_table('timepiece_issuepoints')
