...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProjectWorkRatio', fields ['project']
        db.create_unique('timepiece_projectworkratio', ['project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectWorkRatio', fields ['project']
        db.delete_unique('timepiece_projectworkratio', ['project_id'])
    ...
    models = {
        ...
        'timepiece.projectworkratio': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Project']", 'unique': 'True'}),
