...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DevChecklist'
        db.create_table(u'timepiece_devchecklist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], blank=True)),
            ('has_reviewed_previous_days_issues', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('description_has_testable', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_reviewed_description_for_todays_issues', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('are_the_estimates_wildly_out', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('passed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dev_checklist_created_by', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'timepiece', ['DevChecklist'])


    def backwards(self, orm):
        # Deleting model 'DevChecklist'
        db.delete_table(u'timepiece_devchecklist')
