...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.start_dev_at'
        db.add_column(u'timepiece_project', 'start_dev_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Project.start_internal_qa_at'
        db.add_column(u'timepiece_project', 'start_internal_qa_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Project.start_client_qa_at'
        db.add_column(u'timepiece_project', 'start_client_qa_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Project.invoice_at'
        db.add_column(u'timepiece_project', 'invoice_at',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


        # Changing field 'Project.colour'
        db.alter_column(u'timepiece_project', 'colour', self.gf(u'colorful.fields.RGBColorField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Project.start_dev_at'
        db.delete_column(u'timepiece_project', 'start_dev_at')

        # Deleting field 'Project.start_internal_qa_at'
        db.delete_column(u'timepiece_project', 'start_internal_qa_at')

        # Deleting field 'Project.start_client_qa_at'
        db.delete_column(u'timepiece_project', 'start_client_qa_at')

        # Deleting field 'Project.invoice_at'
        db.delete_column(u'timepiece_project', 'invoice_at')


        # Changing field 'Project.colour'
        db.alter_column(u'timepiece_project', 'colour', self.gf('colorful.fields.RGBColorField')(max_length=7, null=True))
