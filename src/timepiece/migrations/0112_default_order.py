...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        def _order_issues(project):
            issues = orm['timepiece.issue'].objects.filter(project=project).order_by("id")
            for index, issue in enumerate(issues):
                issue.order = index
                issue.save()
            
        for project in orm["timepiece.project"].objects.all():
            _order_issues(project)
