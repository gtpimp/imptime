...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueAttachment'
        db.create_table('timepiece_issueattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['timepiece.Issue'])),
            ('attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('timepiece', ['IssueAttachment'])


    def backwards(self, orm):
        # Deleting model 'IssueAttachment'
        db.delete_table('timepiece_issueattachment')
