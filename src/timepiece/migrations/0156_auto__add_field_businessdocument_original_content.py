...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessDocument.original_content'
        db.add_column('timepiece_businessdocument', 'original_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessDocument.original_content'
        db.delete_column('timepiece_businessdocument', 'original_content')
