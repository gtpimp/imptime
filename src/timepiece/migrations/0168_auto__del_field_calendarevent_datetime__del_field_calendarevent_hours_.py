...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalendarEvent.datetime'
        db.delete_column(u'timepiece_calendarevent', 'datetime')

        # Deleting field 'CalendarEvent.hours_worked'
        db.delete_column(u'timepiece_calendarevent', 'hours_worked')

        # Deleting field 'CalendarEvent.hours_planned'
        db.delete_column(u'timepiece_calendarevent', 'hours_planned')

        # Adding field 'CalendarEvent.start'
        db.add_column(u'timepiece_calendarevent', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Adding field 'CalendarEvent.hours'
        db.add_column(u'timepiece_calendarevent', 'hours',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=4, decimal_places=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CalendarEvent.datetime'
        db.add_column(u'timepiece_calendarevent', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Adding field 'CalendarEvent.hours_worked'
        db.add_column(u'timepiece_calendarevent', 'hours_worked',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'CalendarEvent.hours_planned'
        db.add_column(u'timepiece_calendarevent', 'hours_planned',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'CalendarEvent.start'
        db.delete_column(u'timepiece_calendarevent', 'start')

        # Deleting field 'CalendarEvent.hours'
        db.delete_column(u'timepiece_calendarevent', 'hours')
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            'hours': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '4', 'decimal_places': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
