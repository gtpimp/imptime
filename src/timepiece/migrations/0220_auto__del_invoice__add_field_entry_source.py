...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'timepiece_invoice')

        # Adding field 'Entry.source'
        db.add_column(u'timepiece_entry', 'source',
                      self.gf('django.db.models.fields.CharField')(default='emacs', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Invoice'
        db.create_table(u'timepiece_invoice', (
            ('date_paid', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', null=True, to=orm['timepiece.Project'], blank=True)),
            ...
            ('invoice_number', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('paid', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'timepiece', ['Invoice'])

        # Deleting field 'Entry.source'
        db.delete_column(u'timepiece_entry', 'source')
