...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalendarEvent.project'
        db.delete_column(u'timepiece_calendarevent', 'project_id')

        # Adding field 'CalendarEvent.business'
        db.add_column(u'timepiece_calendarevent', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='calendar_events', null=True, to=orm['timepiece.Business']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CalendarEvent.project'
        db.add_column(u'timepiece_calendarevent', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calendar_events', null=True, to=orm['timepiece.Project'], blank=True),
                      keep_default=False)

        # Deleting field 'CalendarEvent.business'
        db.delete_column(u'timepiece_calendarevent', 'business_id')
