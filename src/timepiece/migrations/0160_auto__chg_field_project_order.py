...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('timepiece_project', 'order', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.order'
        db.alter_column('timepiece_project', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
