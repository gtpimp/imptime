...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_deadlines'
        db.add_column(u'timepiece_businesspermissions', 'can_edit_deadlines',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_view_deadlines'
        db.add_column(u'timepiece_businesspermissions', 'can_view_deadlines',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_deadlines'
        db.delete_column(u'timepiece_businesspermissions', 'can_edit_deadlines')

        # Deleting field 'BusinessPermissions.can_view_deadlines'
        db.delete_column(u'timepiece_businesspermissions', 'can_view_deadlines')
