...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.interface_plugin_number'
        db.add_column('timepiece_project', 'interface_plugin_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.interface_plugin_number'
        db.delete_column('timepiece_project', 'interface_plugin_number')
