...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.jira_user_name'
        db.delete_column('timepiece_userprofile', 'jira_user_name')


    def backwards(self, orm):
        # Adding field 'UserProfile.jira_user_name'
        db.add_column('timepiece_userprofile', 'jira_user_name',
