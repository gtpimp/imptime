...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNotification.msg'
        db.add_column(u'timepiece_usernotification', 'msg',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNotification.msg'
        db.delete_column(u'timepiece_usernotification', 'msg')
