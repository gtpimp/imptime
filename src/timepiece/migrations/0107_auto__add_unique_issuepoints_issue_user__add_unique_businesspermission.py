...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IssuePoints', fields ['issue', 'user']
        db.create_unique('timepiece_issuepoints', ['issue_id', 'user_id'])

        # Adding unique constraint on 'BusinessPermissions', fields ['user', 'business']
        db.create_unique('timepiece_businesspermissions', ['user_id', 'business_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BusinessPermissions', fields ['user', 'business']
        db.delete_unique('timepiece_businesspermissions', ['user_id', 'business_id'])

        # Removing unique constraint on 'IssuePoints', fields ['issue', 'user']
        db.delete_unique('timepiece_issuepoints', ['issue_id', 'user_id'])
