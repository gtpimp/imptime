...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinanceChecklist'
        db.create_table(u'timepiece_financechecklist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], blank=True)),
            ('has_valid_budget', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_currently_under_budget', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_projected_cost_in_budget', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('are_rates_correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('passed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='finance_checklist_created_by', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'timepiece', ['FinanceChecklist'])


    def backwards(self, orm):
        # Deleting model 'FinanceChecklist'
        db.delete_table(u'timepiece_financechecklist')
