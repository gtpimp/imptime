...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Feature', fields ['name', 'business']
        db.create_unique('timepiece_feature', ['name', 'business_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feature', fields ['name', 'business']
        db.delete_unique('timepiece_feature', ['name', 'business_id'])
