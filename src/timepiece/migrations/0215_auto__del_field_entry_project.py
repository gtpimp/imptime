...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.project'
        db.delete_column(u'timepiece_entry', 'project_id')


    def backwards(self, orm):
        # Adding field 'Entry.project'
        db.add_column(u'timepiece_entry', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='entries', to=orm['timepiece.Project']),
                      keep_default=False)
