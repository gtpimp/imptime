...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarEvent.caldav_uid'
        db.add_column(u'timepiece_calendarevent', 'caldav_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarEvent.caldav_uid'
        db.delete_column(u'timepiece_calendarevent', 'caldav_uid')
    ...
    models = {
        ...
        u'timepiece.calendarevent': {
            ...
            'caldav_uid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
