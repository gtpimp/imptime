...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_expense', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('timepiece', ['Expense'])

        # Adding model 'Income'
        db.create_table('timepiece_income', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('timepiece', ['Income'])


    def backwards(self, orm):
        # Deleting model 'Expense'
        db.delete_table('timepiece_expense')

        # Deleting model 'Income'
        db.delete_table('timepiece_income')
