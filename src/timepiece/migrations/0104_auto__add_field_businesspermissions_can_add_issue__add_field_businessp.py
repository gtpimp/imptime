...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_add_issue'
        db.add_column('timepiece_businesspermissions', 'can_add_issue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_delete_issue'
        db.add_column('timepiece_businesspermissions', 'can_delete_issue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_add_issue'
        db.delete_column('timepiece_businesspermissions', 'can_add_issue')

        # Deleting field 'BusinessPermissions.can_delete_issue'
        db.delete_column('timepiece_businesspermissions', 'can_delete_issue')
