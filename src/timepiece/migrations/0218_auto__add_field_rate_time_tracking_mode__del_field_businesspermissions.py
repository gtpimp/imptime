...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rate.time_tracking_mode'
        db.add_column(u'timepiece_rate', 'time_tracking_mode',
                      self.gf('django.db.models.fields.CharField')(default='developer', max_length=50),
                      keep_default=False)

        # Deleting field 'BusinessPermissions.time_tracking_mode'
        db.delete_column(u'timepiece_businesspermissions', 'time_tracking_mode')


    def backwards(self, orm):
        # Deleting field 'Rate.time_tracking_mode'
        db.delete_column(u'timepiece_rate', 'time_tracking_mode')

        # Adding field 'BusinessPermissions.time_tracking_mode'
        db.add_column(u'timepiece_businesspermissions', 'time_tracking_mode',
                      self.gf('django.db.models.fields.CharField')(default='developer', max_length=50),
                      keep_default=False)
