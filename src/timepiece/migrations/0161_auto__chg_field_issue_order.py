...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.order'
        db.alter_column('timepiece_issue', 'order', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Issue.order'
        db.alter_column('timepiece_issue', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
