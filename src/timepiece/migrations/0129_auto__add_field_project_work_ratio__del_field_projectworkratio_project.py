...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.work_ratio'
        db.add_column('timepiece_project', 'work_ratio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.ProjectWorkRatio'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProjectWorkRatio.project'
        db.delete_column('timepiece_projectworkratio', 'project_id')


    def backwards(self, orm):
        # Deleting field 'Project.work_ratio'
        db.delete_column('timepiece_project', 'work_ratio_id')

        # Adding field 'ProjectWorkRatio.project'
        db.add_column('timepiece_projectworkratio', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['timepiece.Project'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        'timepiece.businesspermissions': {
            ...
            'can_edit_subject': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'can_view_issues': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'can_view_project_card': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'timepiece.issuepoints': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_points'", 'to': "orm['timepiece.Issue']"}),
            'points': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issue_points'", 'to': "orm['auth.User']"})
        },
        'timepiece.location': {
        ...
        'timepiece.project': {
            ...
            'work_ratio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.ProjectWorkRatio']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'timepiece.projectworkratio': {
            'Meta': {'object_name': 'ProjectWorkRatio'},
            'development': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'management': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'testing': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        'timepiece.rate': {
