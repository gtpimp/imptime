...
class Migration(DataMigration):
    ...
    models = {
        ...
        'timepiece.projectrelationship': {
            ...
            'types_old': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'project_relationships_old'", 'blank': 'True', 'to': "orm['crm.RelationshipType']"})
        },
