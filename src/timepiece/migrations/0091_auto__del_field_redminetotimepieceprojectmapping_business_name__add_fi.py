...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RedmineToTimepieceProjectMapping.business_name'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'business_name')

        # Adding field 'RedmineToTimepieceProjectMapping.timepiece_business_name'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_business_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RedmineToTimepieceProjectMapping.business_name'
        db.add_column('timepiece_redminetotimepieceprojectmapping', 'business_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'RedmineToTimepieceProjectMapping.timepiece_business_name'
        db.delete_column('timepiece_redminetotimepieceprojectmapping', 'timepiece_business_name')
