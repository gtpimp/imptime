...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CalendarEvent', fields ['hours']
        db.create_index(u'timepiece_calendarevent', ['hours'])


    def backwards(self, orm):
        # Removing index on 'CalendarEvent', fields ['hours']
        db.delete_index(u'timepiece_calendarevent', ['hours'])
