...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessPermissions'
        db.create_table('timepiece_businesspermissions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='business_permissions', to=orm['timepiece.Business'])),
            ('users', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('can_edit_permissions', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('timepiece', ['BusinessPermissions'])


    def backwards(self, orm):
        # Deleting model 'BusinessPermissions'
        db.delete_table('timepiece_businesspermissions')
