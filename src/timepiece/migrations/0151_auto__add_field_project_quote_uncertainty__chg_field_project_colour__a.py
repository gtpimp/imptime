...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueComment.modified'
        db.add_column('timepiece_issuecomment', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 10, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'IssueComment.created'
        db.alter_column('timepiece_issuecomment', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'IssueComment.modified'
        db.delete_column('timepiece_issuecomment', 'modified')


        # Changing field 'IssueComment.created'
        db.alter_column('timepiece_issuecomment', 'created', self.gf('django.db.models.fields.DateTimeField')())
