...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Jira'
        db.create_table('timepiece_jira', (
        ...
        db.send_create_signal('timepiece', ['Jira'])

        # Adding index on 'Project', fields ['name']
        db.create_index('timepiece_project', ['name'])

        # Adding index on 'Project', fields ['description']
        db.create_index('timepiece_project', ['description'])

        # Adding field 'Business.sync_with'
        db.add_column('timepiece_business', 'sync_with',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'Project', fields ['description']
        db.delete_index('timepiece_project', ['description'])

        # Removing index on 'Project', fields ['name']
        db.delete_index('timepiece_project', ['name'])

        # Deleting model 'Jira'
        db.delete_table('timepiece_jira')

        # Deleting field 'Business.sync_with'
        db.delete_column('timepiece_business', 'sync_with')
