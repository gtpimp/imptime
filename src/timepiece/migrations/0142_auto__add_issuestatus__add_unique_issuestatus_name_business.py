...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_issuestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stati', to=orm['timepiece.Business'])),
        ))
        db.send_create_signal('timepiece', ['IssueStatus'])

        # Adding unique constraint on 'IssueStatus', fields ['name', 'business']
        db.create_unique('timepiece_issuestatus', ['name', 'business_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'IssueStatus', fields ['name', 'business']
        db.delete_unique('timepiece_issuestatus', ['name', 'business_id'])

        # Deleting model 'IssueStatus'
        db.delete_table('timepiece_issuestatus')
