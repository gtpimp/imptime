...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalendarEvent.date'
        db.delete_column(u'timepiece_calendarevent', 'date')
    ...
    def backwards(self, orm):
        # Adding field 'CalendarEvent.date'
        db.add_column(u'timepiece_calendarevent', 'date',
