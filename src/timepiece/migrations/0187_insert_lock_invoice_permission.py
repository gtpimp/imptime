...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        content_type = ContentType.objects.get_or_create(app_label="invoicing", model="Invoice")[0]

        Permission.objects.create(codename='can_unlock_invoices', name='Can unlock invoices', content_type=content_type)
