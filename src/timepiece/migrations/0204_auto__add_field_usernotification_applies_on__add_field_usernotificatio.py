...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNotification.applies_on'
        db.add_column(u'timepiece_usernotification', 'applies_on',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserNotification.seen'
        db.add_column(u'timepiece_usernotification', 'seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNotification.applies_on'
        db.delete_column(u'timepiece_usernotification', 'applies_on')

        # Deleting field 'UserNotification.seen'
        db.delete_column(u'timepiece_usernotification', 'seen')
