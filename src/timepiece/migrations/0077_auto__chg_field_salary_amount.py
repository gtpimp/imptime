...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Salary.amount'
        db.alter_column('timepiece_salary', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Salary.amount'
        db.alter_column('timepiece_salary', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=0))
