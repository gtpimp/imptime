...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueAttachment.name'
        db.add_column('timepiece_issueattachment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueAttachment.name'
        db.delete_column('timepiece_issueattachment', 'name')
