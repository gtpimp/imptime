...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessStateColour'
        db.create_table('timepiece_businessstatecolour', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('colour', self.gf('colorful.fields.RGBColorField')(max_length=7, null=True, blank=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='state_colours', to=orm['timepiece.Business'])),
        ))
        db.send_create_signal('timepiece', ['BusinessStateColour'])


    def backwards(self, orm):
        # Deleting model 'BusinessStateColour'
        db.delete_table('timepiece_businessstatecolour')
    ...
    models = {
        ...
        'timepiece.businessstatecolour': {
            'Meta': {'object_name': 'BusinessStateColour'},
            'business': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'state_colours'", 'to': "orm['timepiece.Business']"}),
