...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_feature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Business'])),
        ))
        db.send_create_signal('timepiece', ['Feature'])

        # Adding field 'Issue.feature'
        db.add_column('timepiece_issue', 'feature',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='issue', unique=True, null=True, to=orm['timepiece.Issue']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Feature'
        db.delete_table('timepiece_feature')
    ...
    models = {
        ...
        'timepiece.feature': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timepiece.Business']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'timepiece.hourgroup': {
        ...
        'timepiece.issue': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'feature': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'issue'", 'unique': 'True', 'null': 'True', 'to': "orm['timepiece.Issue']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
