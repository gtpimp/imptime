...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timepiece_issuehistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('before', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('after', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('timepiece', ['IssueHistory'])


    def backwards(self, orm):
        # Deleting model 'IssueHistory'
        db.delete_table('timepiece_issuehistory')
