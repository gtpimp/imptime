...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_quotes'
        db.add_column(u'timepiece_businesspermissions', 'can_edit_quotes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BusinessPermissions.can_view_quotes'
        db.add_column(u'timepiece_businesspermissions', 'can_view_quotes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_quotes'
        db.delete_column(u'timepiece_businesspermissions', 'can_edit_quotes')

        # Deleting field 'BusinessPermissions.can_view_quotes'
        db.delete_column(u'timepiece_businesspermissions', 'can_view_quotes')
