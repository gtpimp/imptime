...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'timepiece_holiday', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applies_on', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='public holiday', max_length=100, blank=True)),
        ))
        db.send_create_signal(u'timepiece', ['Holiday'])


    def backwards(self, orm):
        # Deleting model 'Holiday'
        db.delete_table(u'timepiece_holiday')
