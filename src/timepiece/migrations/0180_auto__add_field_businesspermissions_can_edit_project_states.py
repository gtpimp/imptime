...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_edit_project_states'
        db.add_column(u'timepiece_businesspermissions', 'can_edit_project_states',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_edit_project_states'
        db.delete_column(u'timepiece_businesspermissions', 'can_edit_project_states')
