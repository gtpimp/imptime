...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_assign_user'
        db.add_column('timepiece_businesspermissions', 'can_assign_user',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_assign_user'
        db.delete_column('timepiece_businesspermissions', 'can_assign_user')
