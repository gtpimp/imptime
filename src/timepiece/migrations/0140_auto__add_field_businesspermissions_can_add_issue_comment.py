...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPermissions.can_add_issue_comment'
        db.add_column('timepiece_businesspermissions', 'can_add_issue_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPermissions.can_add_issue_comment'
        db.delete_column('timepiece_businesspermissions', 'can_add_issue_comment')
