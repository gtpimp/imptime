...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('timepiece_issue', 'assigned_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assigned_issues', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.assigned_to'
        db.delete_column('timepiece_issue', 'assigned_to_id')
