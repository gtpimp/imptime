...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.paid'
        db.add_column('timepiece_expense', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.paid'
        db.add_column('timepiece_invoice', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.paid'
        db.delete_column('timepiece_expense', 'paid')

        # Deleting field 'Invoice.paid'
        db.delete_column('timepiece_invoice', 'paid')
