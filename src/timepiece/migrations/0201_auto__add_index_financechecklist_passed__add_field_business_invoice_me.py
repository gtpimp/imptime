...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'FinanceChecklist', fields ['passed']
        db.create_index(u'timepiece_financechecklist', ['passed'])

        # Adding field 'Business.invoice_method'
        db.add_column(u'timepiece_business', 'invoice_method',
                      self.gf('django.db.models.fields.CharField')(default='billable_hours', max_length=50, blank=True),
                      keep_default=False)

        # Adding index on 'TrafficChecklist', fields ['passed']
        db.create_index(u'timepiece_trafficchecklist', ['passed'])

        # Adding index on 'DevChecklist', fields ['passed']
        db.create_index(u'timepiece_devchecklist', ['passed'])


    def backwards(self, orm):
        # Removing index on 'DevChecklist', fields ['passed']
        db.delete_index(u'timepiece_devchecklist', ['passed'])

        # Removing index on 'TrafficChecklist', fields ['passed']
        db.delete_index(u'timepiece_trafficchecklist', ['passed'])

        # Removing index on 'FinanceChecklist', fields ['passed']
        db.delete_index(u'timepiece_financechecklist', ['passed'])

        # Deleting field 'Business.invoice_method'
        db.delete_column(u'timepiece_business', 'invoice_method')
    ...
    models = {
        ...
        u'timepiece.business': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_method': ('django.db.models.fields.CharField', [], {'default': "'billable_hours'", 'max_length': '50', 'blank': 'True'}),
        ...
        u'timepiece.financechecklist': {
            ...
            'all_invoices_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'all_sprints_closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
