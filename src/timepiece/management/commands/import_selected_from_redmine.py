...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        redmine_business_name = 'swift silliker'
        #redmine_sprint_name = 'sprint6'
        #timepiece_sprint_id = 1305
        timepiece_business_name = 'swift'
        timepiece_username = 'gtp'
        ...
        redmine_issues_qs = redmine_issues_qs.filter(project__name=redmine_business_name)
        ...
        for redmine_issue in redmine_issues:
            ...
            issue = models.Issue.objects.get(project__business__name=timepiece_business_name, number=redmine_issue.id)
