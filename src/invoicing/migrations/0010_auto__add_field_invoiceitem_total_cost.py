...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoiceItem.total_cost'
        db.add_column(u'invoicing_invoiceitem', 'total_cost',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoiceItem.total_cost'
        db.delete_column(u'invoicing_invoiceitem', 'total_cost')
