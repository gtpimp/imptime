...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.quote_document'
        db.add_column(u'invoicing_quote', 'quote_document',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.BusinessDocument'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quote.additional_document'
        db.add_column(u'invoicing_quote', 'additional_document',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Invoice.locked'
        db.delete_column(u'invoicing_invoice', 'locked')


    def backwards(self, orm):
        # Deleting field 'Quote.quote_document'
        db.delete_column(u'invoicing_quote', 'quote_document_id')

        # Deleting field 'Quote.additional_document'
        db.delete_column(u'invoicing_quote', 'additional_document')

        # Adding field 'Invoice.locked'
        db.add_column(u'invoicing_invoice', 'locked',
