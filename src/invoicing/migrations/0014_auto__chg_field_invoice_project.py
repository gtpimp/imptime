...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.project'
        db.alter_column(u'invoicing_invoice', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Project'], null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.project'
        db.alter_column(u'invoicing_invoice', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Project']))
