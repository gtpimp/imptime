...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.invoice_note'
        db.alter_column(u'invoicing_invoice', 'invoice_note', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.invoice_note'
        db.alter_column(u'invoicing_invoice', 'invoice_note', self.gf('django.db.models.fields.TextField')(null=True))
