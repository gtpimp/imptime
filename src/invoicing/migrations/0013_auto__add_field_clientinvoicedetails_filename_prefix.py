...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientInvoiceDetails.filename_prefix'
        db.add_column(u'invoicing_clientinvoicedetails', 'filename_prefix',
                      self.gf('django.db.models.fields.CharField')(default='hi', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientInvoiceDetails.filename_prefix'
        db.delete_column(u'invoicing_clientinvoicedetails', 'filename_prefix')
