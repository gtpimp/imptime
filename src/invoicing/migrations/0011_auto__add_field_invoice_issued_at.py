...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.issued_at'
        db.add_column(u'invoicing_invoice', 'issued_at',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.issued_at'
        db.delete_column(u'invoicing_invoice', 'issued_at')
