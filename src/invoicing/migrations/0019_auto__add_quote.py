...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'invoicing_quote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoicing.ClientInvoiceDetails'])),
            ('internal_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Business'], blank=True)),
            ...
            ('sent_to_client_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'invoicing', ['Quote'])


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'invoicing_quote')
    ...
    models = {
        ...
        u'invoicing.quote': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Project']", 'null': 'True', 'blank': 'True'}),
            'sent_to_client_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'open'", 'max_length': '20'})
        },
