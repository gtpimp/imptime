...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'invoicing_invoice', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=999, to=orm['timepiece.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.project'
        db.delete_column(u'invoicing_invoice', 'project_id')
