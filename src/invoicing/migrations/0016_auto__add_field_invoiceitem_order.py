...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoiceItem.order'
        db.add_column(u'invoicing_invoiceitem', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoiceItem.order'
        db.delete_column(u'invoicing_invoiceitem', 'order')
