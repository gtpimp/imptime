...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoicePayment.paid_at'
        db.alter_column(u'invoicing_invoicepayment', 'paid_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'InvoicePayment.paid_at'
        db.alter_column(u'invoicing_invoicepayment', 'paid_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
