...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.business'
        db.add_column(u'invoicing_invoice', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timepiece.Business'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.business'
        db.delete_column(u'invoicing_invoice', 'business_id')
