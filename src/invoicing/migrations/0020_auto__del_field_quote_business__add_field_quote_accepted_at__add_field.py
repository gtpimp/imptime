...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quote.business'
        db.delete_column(u'invoicing_quote', 'business_id')

        # Adding field 'Quote.accepted_at'
        db.add_column(u'invoicing_quote', 'accepted_at',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quote.currency_symbol'
        db.add_column(u'invoicing_quote', 'currency_symbol',
                      self.gf('django.db.models.fields.CharField')(default='R', max_length=3),
                      keep_default=False)


        # Changing field 'Quote.sent_to_client_at'
        db.alter_column(u'invoicing_quote', 'sent_to_client_at', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Adding field 'Quote.business'
        db.add_column(u'invoicing_quote', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timepiece.Business'], blank=True),
                      keep_default=False)

        # Deleting field 'Quote.accepted_at'
        db.delete_column(u'invoicing_quote', 'accepted_at')

        # Deleting field 'Quote.currency_symbol'
        db.delete_column(u'invoicing_quote', 'currency_symbol')


        # Changing field 'Quote.sent_to_client_at'
        db.alter_column(u'invoicing_quote', 'sent_to_client_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 2, 21, 0, 0)))
    ...
    models = {
        ...
        u'invoicing.quote': {
            ...
            'accepted_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.Project']", 'null': 'True', 'blank': 'True'}),
            'sent_to_client_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'open'", 'max_length': '20'})
        },
