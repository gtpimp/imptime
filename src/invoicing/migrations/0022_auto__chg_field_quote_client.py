...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.client'
        db.alter_column(u'invoicing_quote', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoicing.ClientInvoiceDetails'], null=True))

    def backwards(self, orm):

        # Changing field 'Quote.client'
        db.alter_column(u'invoicing_quote', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['invoicing.ClientInvoiceDetails']))
    ...
    models = {
        ...
        u'invoicing.quote': {
            ...
            'additional_document': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['invoicing.ClientInvoiceDetails']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'currency_symbol': ('django.db.models.fields.CharField', [], {'default': "'R'", 'max_length': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'quotes'", 'null': 'True', 'to': u"orm['timepiece.Project']"}),
            'quote_document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timepiece.BusinessDocument']", 'null': 'True', 'blank': 'True'}),
