...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.internal_comment'
        db.add_column(u'invoicing_invoice', 'internal_comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.internal_comment'
        db.delete_column(u'invoicing_invoice', 'internal_comment')
