...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoicePayment.description'
        db.add_column(u'invoicing_invoicepayment', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoicePayment.description'
        db.delete_column(u'invoicing_invoicepayment', 'description')
