        ...
        for p_id, hours_before in self.timings_before.items():
            ...
            if hours_before != hours_after:
                ...
                if not project.is_open:
                    raise Exception("Trying to add entries to a closed project [%s - %s]. Expected %s hours, but trying to add %s hours." % (project.business.name, project, hours_before, hours_after))
