...
ADMINS = (("Gareth Priede", "gtp@implicitdesign.co.za"),)
...
REDMINE_DB_MAPPING = [
    {"username": "test", "business": "projects", "db": "redmine_projects"}
]
...
CALDAV_INCOMING_CALDAV_CHANGES_FOLDER = os.path.join(
    PROJECT_HOME, "..", "..", "incoming_caldav_changes"
)
...
EMACSIMPORTER_RATES = {
    "test": {"id-test.org": 50, "id-koen.org": 100, "id-fonk.org": 200}
}
EMACSIMPORTER_TEMP_DIR = "/tmp"
EMACS_USERS_TO_PROCESS = [
    "test",
]
EMACS_ADMIN_USER_EMAILS = [
    "gtp@impd.co.za",
]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "": {"handlers": ["file", "sentry"], "propagate": True, "level": "INFO"},
    },
}
...
#
if os.path.exists(
    os.path.join(PROJECT_HOME, "external_config", "api_local_settings.py")
):
    from implicitdesign.external_config.api_local_settings import *
...
if DATABASES["default"]["ENGINE"] == "django.db.backends.":
    raise Exception(
        "Unconfigured databases setting, please correct in local_settings.py"
    )
