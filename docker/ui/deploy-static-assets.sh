...
cp -R /tmp/build/mobile/build/static/* $STATIC_ASSETS_PATH
...
cp -R /tmp/build/mobile/build/static/* /opt/imptime/global/static_collected/
...
cp /tmp/build/mobile/build/* /opt/imptime/global/static_collected/public/
