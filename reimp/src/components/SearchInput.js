    ...
    render() {
        ...
        return (
            <div className="search-input">
                <div className="search-input__component search-input__icon"><i className="material-icons">search</i></div>
                ...
                <div className="search-input__component search-input__icon" onClick={this.props.onOpenDropDown}>
