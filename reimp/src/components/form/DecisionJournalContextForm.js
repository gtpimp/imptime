...
class DecisionJournalContextForm extends Component {
...
function mapStateToProps(state, props) {
    ...
    return {
        initialValues: {context:props.initial_value},
        enableReinitialize: true,
        onSubmit: onSubmitted,
        onCancel: onCancel,
        textAreaValue: selector(state, 'context')
    }
}

export default connect(mapStateToProps)(reduxForm({form:'decision_journal_decision_form'})(DecisionJournalContextForm))
