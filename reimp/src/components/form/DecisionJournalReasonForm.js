...
class DecisionJournalReasonForm extends Component {
...
function mapStateToProps(state, props) {
    ...
    return {
        initialValues: {reason:props.initial_value},
        enableReinitialize: true,
        onSubmit: onSubmitted,
        onCancel: onCancel,
        textAreaValue: selector(state, 'reason')
    }
}

export default connect(mapStateToProps)(reduxForm({form:'decision_journal_decision_form'})(DecisionJournalReasonForm))
