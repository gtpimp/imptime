...
class SprintTypeForm extends Component {
    ...
    renderSingleValueSelector(field) {
        ...
        return (
            <SingleValueSelector
                ...
                value={input.value}
                options={data}
                rememberer_key={"sprint_type_"+project_id}
                {...rest}
            />
        )
    }
...
function mapStateToProps(state, props) {
    ...
    const type_names = project.allowed_sprint_type_names || []
...
export default connect(mapStateToProps)(reduxForm({form:'sprint_type_form'})(SprintTypeForm))
