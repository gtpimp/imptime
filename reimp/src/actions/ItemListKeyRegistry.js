...
export const LIST_KEY__TINY_ISSUES_CARD = 'tiny_issues'
export const LIST_KEY__TINY_USERS_CARD = 'tiny_users'
export const LIST_KEY__MY_ISSUE_LIST_DUE_NOW = 'my_issues_due_now'
export const LIST_KEY__MY_ASSIGNED_ISSUE_LIST = 'my_assigned_issue_list'
...
export const ENTITY_KEY__TESTABLE = 'testable'
...
export const HEADER_LIST_NAME__WIKI = "wiki"
