...
// // Copied from react-xhr-uploader, modified to support authentication headers during upload (lines marked with imp comment)
...
var _styles = require('./xhruploader_styles');
...
XHRUploader.propTypes = {
    ...
    dropzoneLabel: _react.PropTypes.string,
    chunks: _react.PropTypes.bool,
    chunkSize: _react.PropTypes.number,
    maxFiles: _react.PropTypes.number,
    clearTimeOut: _react.PropTypes.number,
    filesetTransitionName: _react.PropTypes.string,
    styles: _react.PropTypes.shape({}),
    cancelIconClass: _react.PropTypes.string,
    completeIconClass: _react.PropTypes.string,
    uploadIconClass: _react.PropTypes.string,
    progressClass: _react.PropTypes.string
};
